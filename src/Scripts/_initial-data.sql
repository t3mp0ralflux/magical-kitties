...
insert into globalsetting(id, name, value)
values('545c30a9-f23d-4366-9c7f-10d7b24c4700', 'activation_email_format', '<p>Your activation link is:</p><p><a href=\"{0}\">{0}</a></p><p>For security reasons, do not share this link with anyone. This link will stop working after {2} minutes.</p><p>Activation link expired? Click <a href=\"{1}\">here</a></p><p>To keep future security messages like this from going to spam or junk email, Add no-reply@mail.magicalkitties.com to your approved or safe sender list.</p><p>If you did not make this request, contact us. Please do not respond to this email.</p>');
...
insert into flaw(id, name, description, is_custom)
values('26', 'Gullible', 'You are too innocent and trusting. You believe just about anything somebody tells you.', false);
insert into flaw(id, name, description, is_custom)
values('31', 'Hallucinations', 'You often see or hear things that are not really there.', false);
insert into flaw(id, name, description, is_custom)
values('32', 'Hyperactive', 'You are full of boundless energy, and aren''t satisfied unless you''re doing something.', false);
insert into flaw(id, name, description, is_custom)
...
insert into flaw(id, name, description, is_custom)
values('43', 'Nosey', 'You have a thirst for knowledge and are eager to investigate anything unusual, even if this annoys others.', false);
insert into flaw(id, name, description, is_custom)
...
insert into talent(id, name, description, is_custom)
values('43', 'Night Vision', 'The night is your friend. You can easily see where you''re going, even in total darkness.', false);
insert into talent(id, name, description, is_custom)
...
insert into upgradechoice(id, name, upgrade_option)
values('d54036bb-a755-4d86-8774-78715bbf1d30', 'Gain a Bonus Feature for a Magical Power you have', 0);
insert into upgradechoice(id, name, upgrade_option)
values('6a244a6e-5fd9-4574-93e1-78193c7d85b6', 'Improve 1 Attribute (Max 3)', 1);
insert into upgradechoice(id, name, upgrade_option)
values('25b47167-600d-41c0-ad78-a404295d9bd8', 'Improve 1 Attribute (Max 4)', 2);
insert into upgradechoice(id, name, upgrade_option)
values('7712d17b-e553-402c-8467-4d9b2389956b', 'Increase Owie Limit +1', 3);
insert into upgradechoice(id, name, upgrade_option)
values('490b8218-01a7-4949-b993-9ce73061e749', 'Increase Kitty Treats +1', 4);
insert into upgradechoice(id, name, upgrade_option)
values('84725926-e714-4fee-8143-a05d58a24589', 'Gain Talent', 5);
insert into upgradechoice(id, name, upgrade_option)
values('ac4bffa2-396b-437d-9ea8-cb2788edac5d', 'New Magical Power', 6);
...
insert into upgraderule(id, block, upgrade_choice)
